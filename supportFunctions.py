...
def draw_bbox(nm,counter,level, image, bboxes, CLASSES=YOLO_COCO_CLASSES, show_label=True, show_confidence=True,
    ...
    for i, bbox in enumerate(bboxes):
        ...
        image = cv2.rectangle(image, (x1, y1), (x2, y2), color1, 1)
